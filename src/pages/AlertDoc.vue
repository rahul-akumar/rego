...
import { Plus, Bell, X } from "lucide-vue-next";
...
<template>
  <div class="flex flex-col m-10 gap-10 bg-transparent">
    <section class="flex-col">
      <h1 class="text-4xl pb-1 font-bold text-black dark:text-white">Alert</h1>
    ...
    <div class="flex flex-col items-start gap-6">
      ...
      <div :class="styles.inspectFrame">
        <Button @click="toggleAppAlert" size="md" variant="primary">
    ...
    <section class="space-y-4">
      ...
      <div class="flex flex-col gap-4 max-w-xl">
        <Alert>
          <template #default
            >This alert uses the default slot for custom content.</template
          >
        </Alert>
        <Alert important>
          <template #icon>
    ...
    <section class="space-y-4">
      ...
      <div class="flex flex-col gap-4 max-w-xl">
        <Alert important>
          ...
          <!-- Button slot -->
          <template #button>
            <Button size="xs" inverted>Take Action</Button>
          </template>

          <!-- Actions slot -->
          <template #actions>
            <Button size="xs" variant="ghost" iconOnly inverted>
              <template #icon>
                <X class="size-5" />
              </template>
            </Button>
