...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, readBody, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/rahul/dev/rego/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/rahul/dev/rego/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/rahul/dev/rego/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/rahul/dev/rego/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/rahul/dev/rego/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/rahul/dev/rego/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/rahul/dev/rego/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/rahul/dev/rego/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/rahul/dev/rego/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/rahul/dev/rego/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/rahul/dev/rego/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/rahul/dev/rego/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/rahul/dev/rego/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/rahul/dev/rego/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/rahul/dev/rego/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/rahul/dev/rego/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/rahul/dev/rego/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/rahul/dev/rego/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/rahul/dev/rego/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/rahul/dev/rego/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/rahul/dev/rego/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/rahul/dev/rego/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/rahul/dev/rego/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/rahul/dev/rego/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/rahul/dev/rego/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/rahul/dev/rego/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/rahul/dev/rego/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/rahul/dev/rego/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/rahul/dev/rego/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/rahul/dev/rego/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/rahul/dev/rego/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/rahul/dev/rego/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rahul/dev/rego","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rahul/dev/rego/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rahul/dev/rego/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rahul/dev/rego/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/rahul/dev/rego/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/rahul/dev/rego/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "icon": {
...
const _5t4HQSl9m9OUHfK5xcL9eRjCgPg5xYEvjumPI3Rl_zo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/rahul/dev/rego";
...
const _nex8nNtrhgjEdbBX_3Z8BUL58jG6mnVkDPgexeU_qk = (nitroApp) => {
...
const plugins = [
  _5t4HQSl9m9OUHfK5xcL9eRjCgPg5xYEvjumPI3Rl_zo,
_nex8nNtrhgjEdbBX_3Z8BUL58jG6mnVkDPgexeU_qk
];
...
const _x74suE = eventHandler((event) => {
...
const checksums = {
  "content": "v3.5.0--WA8ft4rSlvOAww-mDDUcd2lWPbBAE-Oy4VpVNzNshFc"
};
...
const _M1SFJm = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/rahul/dev/rego/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/rahul/dev/rego/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _N8Dgaf = eventHandler(async (event) => {
  ...
  return await import('file:///Users/rahul/dev/rego/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _LHDOrI = eventHandler(async (event) => {
...
const _npkT8u = lazyEventHandler(() => {
...
const _lazy_1rx1Oq = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _x74suE, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_1rx1Oq, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _M1SFJm, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _N8Dgaf, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _LHDOrI, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _npkT8u, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_1rx1Oq, lazy: true, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_1rx1Oq, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1rx1Oq, lazy: true, middleware: false, method: undefined }
];
